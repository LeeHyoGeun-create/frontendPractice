...
//     sendResponse("20 다시보냄");
//   } else if (message.value == "40") {
//     sendResponse("40 다시보냄");
//   }
// });
...
//   });
//   console.log(`source : ${raster.source}`);
...
//       let { R, G, B } = getRgbColor(raster, i, j);
//       console.log(`R,G,B : ${R}, ${G}, ${B}`);
//       let { h, s, l } = rgbToHsl(R, G, B);
//       console.log(`H is ${h}`);
//       let color = matchColor(h);
...
// function getRgbColor(raster, i, j) {
//   console.log(`i, j : ${i}, ${j}`);
...
// function matchColor(hsl) {
//   if (18 < hsl && hsl <= 54) {
//     return "YR";
//   } else if (54 < hsl && hsl <= 90) {
//     return "Y";
//   } else if (90 < hsl && hsl <= 126) {
//     return "GY";
//   } else if (126 < hsl && hsl <= 162) {
//     return "G";
//   } else if (162 < hsl && hsl <= 198) {
//     return "BG";
//   } else if (198 < hsl && hsl <= 234) {
//     return "B";
//   } else if (234 < hsl && hsl <= 270) {
//     return "PB";
//   } else if (270 < hsl && hsl <= 306) {
//     return "P";
//   } else if (306 < hsl && hsl <= 342) {
//     return "RP";
//   } else {
//     return "R";
//   }
...
const draw = (img, id) => {
  ...
  for (let i = 0; i < img.clientWidth; i += level.count) {
    for (let j = 0; j < img.clientHeight; j += level.count) {
      ...
      const circle = new Path.Circle(new Point(i, j), 1);
      circle.fillColor = "white";
      let hex = getHexColor(raster, i, j);
...
//       const circle = new Path.Circle(new Point(i, j), 1);
//       circle.fillColor = "white";
//       let { r, g, b } = getHexColor(raster, i, j);
